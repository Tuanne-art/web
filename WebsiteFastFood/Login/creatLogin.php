                    ...
                    <?php
                        if (isset($_POST['bnt-submit']) and $_POST['bnt-submit'] == 'Đăng Ký') {
                            ...
                            if ($conn ->query($sql)) {
                                ...
                                $email_to = $email;
                                $subject = "Chào Mừng Bạn Đến Với FAST FOOD";
                                $message = '
                                            <html>
                                                
                                                <img src="https://popofastfood.000webhostapp.com/images/logoPopo.png" width="200px" alt="">
                                                <h2>Chào Mừng Bạn Đến Với FAST FOOD</h2>
                                                <div class="content">
                                                    <p>Bạn Đã Đăng Ký Thành Công Tài Khoản FAST FOOD.<br>
                                                        Bây giờ bạn có thể thỏa sức đăt mua những món ăn ngon trên hệ thống đồ ăn nhanh FAST FOOD</p>
                                ...
                                insertNotification("Chào Mừng Bạn Đến Với FAST FOOD","Bạn đã đăng ký thành công và được tặng một mã free ship: ","$codeDiscount",$row['id_new']);
