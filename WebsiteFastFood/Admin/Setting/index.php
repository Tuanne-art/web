...
<body>
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a href="../Discount_AD/index.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Quản Lý Mã Giảm Giá</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Cài đặt thông tin website</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="setting_contact">
                                            ...
                                            <div class="edit_contact">
                                                <form action="" method="post" method="post">
                                                    ...
                                                    <button class="bnt_submit" name="bntEditContact" id="bnt_Updatecontact" onclick="return showInpContact()" value="edit">Thay đổi</button>
                                                </form>
                                                <?php 
    ...
    <script src="./jsSetting.js"></script>
</body>
