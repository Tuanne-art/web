                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a href="../Category_AD/" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Quản Lý Bình Luận</h5>
                                            <p class="m-b-0">Quản lý Các Bình Luận Của Khách Hàng Cho Sản Phẩm Của Bạn !</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <?php if (isset($_GET['idProduct'])) {?>
                                        <form action="" method="post">
                                            <div class="title_product">
                                                <?php showProductName($_GET['idProduct']); ?>
                                                <a href="./index.php"><i class="fas fa-angle-double-left"></i> Quay lại trang quản lý bình luận</a>
                                            </div>
                                            ...
                                            <div class="box_content_comment">
                                                <?php showCommentDetail($_GET['idProduct'])?>
                                            </div>
                                        </form>
                                        <?php 
                                            if (isset($_POST['bntSentComment'])) {
                                                sentComment($_POST['valComment'],$_GET['idProduct'],$idCustomer);
                                            }
