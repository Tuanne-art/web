...
<head>
    ...
    <!-- carousel -->
    <link rel="icon" href="./images/LogoFastfood.png" type="image/x-icon">
    ...
    <div class="containerr">
        ...
        <footer>
                ...
                <div class="contact_information">
                    ...
                    <div class="contact_information_content">
                        <p class="contact_information_content_sub">
                            Các chính sách và quy định chung này liên quan đến việc Khách hàng sử dụng website của FAST FOOD
                        </p>
            ...
            <div class="copy_right">
                <p>Copyright 2023 © FAST FOOD. Bản Quyền Thuộc FAST FOOD</p>
            </div>
        </footer>
    </div>
